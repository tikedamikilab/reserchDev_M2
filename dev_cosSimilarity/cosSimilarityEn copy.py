...
DATASET_FILE_PATH = "./datasets/problemlist_bruteforce_sample.csv"
...
# calculate tf_idf
# ソースコード
input_dataset = numpy.array(dataset["text"])
#設定
...
with open("./dataset_output/tmp.csv", 'a',newline='',encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerows(cs)
